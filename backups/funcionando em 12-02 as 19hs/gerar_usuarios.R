...
ficticios <- data.frame(
  ...
  nome = paste0(sample( c("Miguel",  "Arthur",  "Gael",  "Théo",  "Heitor",  "Ravi",  "Davi",  "Bernardo",  "Noah",  "Gabriel",  "Helena",  "Alice",  "Laura",  "Maria Alice",  "Sophia",  "Manuela",  "Maitê",  "Liz",  "Cecília",  "Isabella",  "Paula", "Michel", "Francisco", "Renzo"), n, replace = TRUE)," ", sample(c("Miguel",  "Arthur",  "Gael",  "Théo",  "Heitor",  "Ravi",  "Davi",  "Bernardo",  "Noah",  "Gabriel",  "Helena",  "Alice",  "Laura",  "Maria Alice",  "Sophia",  "Manuela",  "Maitê",  "Liz",  "Cecília",  "Isabella",  "Paula", "Michel", "Francisco", "Renzo"), n, replace = TRUE) ),
